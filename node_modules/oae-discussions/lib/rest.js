...
/*!
 * Update a discussion (edit discussion details)
 */
 ...
 * also increment view count by 1
 */
OAE.tenantServer.get('/api/discussion/:discussionId', function(req, res) {
    ...
    DiscussionsAPI.Discussions.getFullDiscussionProfile(req.ctx, req.params.discussionId, function(err, discussion) {
        ...
        var viewCountUpdate = {viewCount: discussion.viewCount+1};       
        DiscussionsAPI.Discussions.updateDiscussion(req.ctx, req.params.discussionId,
                                                   viewCountUpdate, function(err) {
            if (err) {
                return res.send(err.code, err.msg);
            }
        });
 ...
 * also increment reply count by 1
 */
OAE.tenantServer.post('/api/discussion/:discussionId/messages', function(req, res) {
    ...
    DiscussionsAPI.Discussions.createMessage(req.ctx, req.params.discussionId, req.body.body, req.body.replyTo, function(err, message) {
        ...
        // increment reply count by 1
        var replyCountUpdate = {replyCount: discussion.replyCount+1};       
            DiscussionsAPI.Discussions.updateDiscussion(req.ctx, req.params.discussionId,
                                                    replyCountUpdate, function(err) {
                if (err) {
                    return res.send(err.code, err.msg);
                }
            });
 ...
 * also decrement reply count by 1
 */
